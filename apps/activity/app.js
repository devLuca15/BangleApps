      ...
      this._l = {
        ...
        c: [
          this._l,
          {
            ...
            c: buttons.map(
              (b) => (
                (b.type = "btn"), (b.filly = 1), (b.width = 32), (b.r = 1), b
              )
            ),
          },
        ],
...
Layout.prototype.setUI = function () {
  ...
  if (this.options.back && !uiSet)
    Bangle.setUI({ mode: "custom", back: this.options.back });
  ...
  if (this.b) {
    ...
    Bangle.btnWatches = [];
    if (this.b[0])
      Bangle.btnWatches.push(
        setWatch(pressHandler.bind(this, 0), BTN1, { repeat: true, edge: -1 })
      );
    if (this.b[1])
      Bangle.btnWatches.push(
        setWatch(pressHandler.bind(this, 1), BTN2, { repeat: true, edge: -1 })
      );
    if (this.b[2])
      Bangle.btnWatches.push(
        setWatch(pressHandler.bind(this, 2), BTN3, { repeat: true, edge: -1 })
      );
  }
    ...
    txt: function (l) {
      if (l.wrap) {
        ...
        lines.forEach((line, i) =>
          g.drawString(line, l.x + (l.w >> 1), y + g.getFontHeight() * i)
        );
      } else {
        g.setFont(l.font)
    ...
    case "h": {
      ...
      l.c.forEach((c) => {
        ...
        c.y =
          ...
          (l.y +
            (0 | l.pad) +
            (((1 + (0 | c.valign)) * (l.h - (l.pad << 1) - c.h)) >> 1));
    ...
    case "v": {
      ...
      l.c.forEach((c) => {
        ...
        c.x =
          ...
          (l.x +
            (0 | l.pad) +
            (((1 + (0 | c.halign)) * (l.w - (l.pad << 1) - c.w)) >> 1));
        if (c.c) this.layout(c);
      });
      break;
    }
...
Layout.prototype.debug = function (l, c) {
  if (!l) l = this._l;
  c = c || 1;
  g.setColor(c & 1, c & 2, c & 4).drawRect(
    l.x + c - 1,
    l.y + c - 1,
    l.x + l.w - c,
    l.y + l.h - c
...
Layout.prototype.update = function () {
  ...
  var cb = {
    txt: function (l) {
      if (l.font.endsWith("%"))
        l.font =
          "Vector" + Math.round((g.getHeight() * l.font.slice(0, -1)) / 100);
      if (l.wrap) {
        l._h = l._w = 0;
      } else {
    ...
    btn: function (l) {
      if (l.font && l.font.endsWith("%"))
        l.font =
          "Vector" + Math.round((g.getHeight() * l.font.slice(0, -1)) / 100);
      var m = l.src
        ? g.imageMetrics("function" == typeof l.src ? l.src() : l.src)
        : g.setFont(l.font || "6x8:2").stringMetrics(l.label);
      l._h = 16 + m.height;
      l._w = 20 + m.width;
    },
    img: function (l) {
